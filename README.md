...
Yearly change, Notes and important marks. The "Stocks/ETFs" and "Loans" tabs
need a Date column plus one column per account (Revolut/Trading212/XTB/
Robinhood, and Personal/Twino/PeerBerry respectively).
...
The server keeps running in the background after you close the browser tab —
that's intentional, so relaunching is instant. Stop it with your process
